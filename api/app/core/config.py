...
class Settings(BaseSettings):
    ...
    MAIL_USERNAME: str = config("MAIL_USERNAME", default="", cast=str)
    MAIL_PASSWORD: str = config("MAIL_PASSWORD", default="", cast=str)
    MAIL_FROM: str = config("MAIL_FROM", default="", cast=str)
    MAIL_SERVER: str = config("MAIL_SERVER", default="", cast=str)
